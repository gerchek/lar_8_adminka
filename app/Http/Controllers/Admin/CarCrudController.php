...
class CarCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
      ...
      $this->crud->addColumn(['name' => 'name', 'type' => 'text', 'label' => 'name']);
        $this->crud->addColumn(['name' => 'category_id', 'type' => 'relationship', 'label' => 'category']);
    ...
    protected function setupCreateOperation()
    {
       ...
       $this->crud->addField(['name' => 'category_id', 'type' => 'select', 'label' => 'Category','model'     => "App\Models\Category",'attribute' => 'title']);
        $this->crud->addField(['name' => 'name', 'type' => 'text', 'label' => 'Text']);
        /**
